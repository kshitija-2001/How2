function getMovies(t) {
    axios.get("https://www.omdbapi.com/?apikey=8d5cb2e&s=" + t).then(t => {
        let e = t.data.Search,
            i = "";
...
function movieSelected(t) { return sessionStorage.setItem("movieID", t), window.location = "movie-min.html", !1 }

function getMovie() {
    let t = sessionStorage.getItem("movieID");
    axios.get("https://www.omdbapi.com/?apikey=8d5cb2e&i=" + t).then(t => {
        let e = t.data,
