...
<body>
    ...
    <div class="cardCase">
    <h1>Hobbies and Craft</h1>
        <div class="row row-cols- row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <img src="https://drvidyahattangadi.com/wp-content/uploads/2014/07/A242.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">How to pursue a hobby</h5>
                        <p class="card-text">Making time to pursue a hobby</p>
                        <a href="#" target="popup" type="button" class="btn btn-primary" onclick="window.open('https://www.happify.com/hd/how-to-find-time-to-pursue-a-hobby-you-are-passionate-about/','popup','width=900,height=600'); return false;">
                            Read More
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="https://miro.medium.com/max/12000/1*HV_s78H5G96_lNe8w_i26g.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Why hobbies are important</h5>
                        <p class="card-text">The advantages of having a hobby</p>
                        <a href="#" target="popup" type="button" class="btn btn-primary" onclick="window.open('https://www.skilledatlife.com/why-hobbies-are-important/','popup','width=900,height=600'); return false;">
                            Read More
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="https://thumbs.dreamstime.com/b/i-love-my-hobby-text-lightbox-87482133.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">How to find a hobby you love</h5>
                        <p class="card-text">Confused about which hobby you want to pursue? This article is for you</p>
                        <a href="#" target="popup" type="button" class="btn btn-primary" onclick="window.open('https://www.themuse.com/advice/how-to-find-a-hobby-you-love','popup','width=900,height=600'); return false;">
                            Read More
                        </a>
                    </div>
                </div>
